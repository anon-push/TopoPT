"""
configs/structured3d/semseg-lw-c.py
===========================================
LitePT-LW-C  Semantic Segmentation — Structured3D

bash scripts/train.sh -g 1 -d structured3d -c semseg-lw-c -n semseg-lw-c

Differences vs configs/scannet/semseg-litept-lw-c.py:
  - num_classes          : 20 → 25
  - in_channels          : 6 (same)
  - lr                   : 0.006/0.0006 → 0.012/0.0012
  - epoch                : 1200 → 200
  - eval_epoch           : 100 (same)
  - dataset_type         : ScanNetDataset → Structured3DDataset
  - data_root            : data/scannet → data/structured3d
  - transforms           : two SphereCrop (matches baseline)
  - clip_grad            : 1.0 (same)
"""
...
save_path = "exp/structured3d/semseg-lw-c"
