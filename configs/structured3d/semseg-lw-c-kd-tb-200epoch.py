"""
configs/structured3d/semseg-lw-c-kd-tb.py
===============================================
LitePT-LW-C + SRFD KD — Structured3D Semantic Segmentation
Teacher: LitePT-Base (semseg-litept-base-v1m1)

bash scripts/train.sh -g 1 -d structured3d -c semseg-lw-c-kd-tb -n semseg-lw-c-kd-tb
     ### -w exp/structured3d/semseg-lw-c/model/model_best.pth
...
Differences vs semseg-lw-c-kd-ts.py:
  - teacher_ckpt      : semseg-litept-small-v1m1 → semseg-litept-base-v1m1
  - teacher enc_depths: (2,2,2,6,2)   → (3,3,3,12,3)
  - teacher enc_ch    : (36,72,144,252,504) → (54,108,216,432,576)
  - teacher enc_heads : (2,4,8,14,28) → (3,6,12,24,32)
  - teacher dec_ch    : (72,72,144,252) → (72,108,216,432)
  - teacher dec_heads : (4,4,8,14)    → (4,6,12,24)
  - save_path / name  : …-kd     → …-kd-tb
"""
...
save_path = "exp/structured3d/semseg-lw-c-kd-tb"
